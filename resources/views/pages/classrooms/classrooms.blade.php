        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <button type="button" class="button x-small ml-3 " id="btn_delete_all">
                    ...
                    <form action="{{ route('filterByGrade') }}" method="POST">
                        @csrf
                        <select class="selected" data-style="btn-info" name="Grade_id" required
                                    ...
                                    <div data-repeater-list="List_Classes">
                                        <div data-repeater-item>
                                            <div class="row">
                                                <div class="col">
                                                    <label for="Name"
                                                           class="mr-sm-2">{{ trans('classrooms_trans.Name_class') }} :</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('deleteAll') }}" method="POST">
                    ...
                    <div class="modal-body">
                        {{ trans('classrooms_trans.Warning_class') }}
                        <input class="text" type="hidden" id="delete_all_id" name="all_id" value=''>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{ trans('classrooms_trans.Close') }}</button>
