                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active show" id="months" role="tabpanel"
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ URL::asset('assets/images/blog/05.jpg') }}" alt="">
                                            </div>
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ URL::asset('assets/images/blog/02.jpg') }}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <p class="sm-mb-5 d-block">We also know those epic stories,
                                                    those modern.</p>
                                                <span class="mb-0">by - <b
                                                        class="text-warning">WebminUser</b>
                                                </span>
                                            </div>
                                            <div class="col-md-2 col-sm-6 col-6 sm-mt-20">
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ URL::asset('assets/images/blog/03.jpg') }}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ URL::asset('assets/images/blog/04.jpg') }}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <p class="sm-mb-5 d-block">Remind yourself you have nowhere to
                                                    go except. </p>
                                                <span class="mb-0">by - <b
                                                        class="text-success">PGSinfotech</b>
                                                </span>
                                            </div>
                                            <div class="col-md-2 col-sm-6 col-6 sm-mt-20">
                                    ...
                                    <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ URL::asset('assets/images/blog/09.jpg') }}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ URL::asset('assets/images/blog/06.jpg') }}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="row mb-30">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ URL::asset('assets/images/blog/07.jpg') }}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <span class="mb-0">by - <b
                                                        class="text-success">SamMartin</b>
                                                </span>
                                            </div>
                                            <div class="col-md-2 col-sm-6 col-6 sm-mt-20">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-sm-6">
                                                <img class="img-fluid"
                                                    src="{{ URL::asset('assets/images/blog/08.jpg') }}" alt="">
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                            ...
                            <ul class="list-unstyled">
                                    ...
                                    <div class="media">
                                        <div class="position-relative">
                                            <img class="img-fluid mr-15 avatar-small"
                                                src="{{ URL::asset('assets/images/item/01.png') }}" alt="">
                                        </div>
                                ...
                                <li class="mb-20">
                                    <div class="media">
                                        <div class="position-relative clearfix">
                                            <img class="img-fluid mr-15 avatar-small"
                                                src="{{ URL::asset('assets/images/item/02.png') }}" alt="">
                                        </div>
                                        <div class="media-body">
                                ...
                                <li class="mb-20">
                                    <div class="media">
                                        <div class="position-relative">
                                            <img class="img-fluid mr-15 avatar-small"
                                                src="{{ URL::asset('assets/images/item/03.png') }}" alt="">
                                        </div>
                                        <div class="media-body">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="position-relative clearfix">
                                            <img class="img-fluid mr-15 avatar-small"
                                                src="{{ URL::asset('assets/images/item/04.png') }}" alt="">
                                        </div>
                                        <div class="media-body">
                ...
                <div class="col-xl-4 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="p-4 text-center bg"
                            style="background: url({{ URL::asset('assets/images/bg/01.jpg') }});">
                        ...
                        <div class="card-body text-center position-relative">
                            <div class="avatar-top">
                                <img class="img-fluid w-25 rounded-circle "
                                    src="{{ URL::asset('assets/images/team/13.jpg') }}" alt="">
                            </div>
                            <div class="row">
